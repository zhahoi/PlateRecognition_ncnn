...
int main()
{
    std::string imageFolder = "/home/dell/Code/c++/PlateRecognition_ncnn_v7/data";
    std::string outputFolder = "/home/dell/Code/c++/PlateRecognition_ncnn_v7/result";
    ...
    for (const auto& imgPath : imageList)
    {
        ...
        yolov7_plate.detect(img, objects);
